...
- [ ] **9. Corrigir Winrate por Modo na Tela de Desempenho**
...
- [ ] **10. Corrigir Posição dos Botões de Ação na Card do Player**
...
- [ ] **11. Ajustar Exibição da Winrate em Mapas & Modos**
...
- [ ] **12. Novo Fluxo de Sessões de Treino (Scrims) & Histórico**
...
- [ ] **13. Ajustes de Permissões, Acesso & UX do Backup**
...
- [ ] **14. Ajustes de Usabilidade Mobile**
...
- [ ] **15. Exibir Objetivos do Modo e Sugestões Visuais no Draft**
...
- [ ] **20. Redesign do Layout de Desempenho, Picks e Badges**
...
- [ ] **21. Navegação Sidebar Retrátil (Collapsible)**
...
- [ ] **22. Suporte a Tema Claro / Escuro Automático**
...
- [ ] **26. Alerta de Rotação de Mapas no Dashboard**
